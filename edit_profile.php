    ...
    <div class="row">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    <td style="font-weight: bold;">Relationshio Status</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input class="form-control input-md" type="date" name="u_bitrhday" required value="<?php echo $user_birthday; ?>">
                    </td>
                </tr>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="recovery.php?id=<?php echo $user_id; ?>" method="post" id="f">
                                            <strong>What is your School best Friend Name?
                                            </strong>

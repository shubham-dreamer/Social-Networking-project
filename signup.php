...
<body>
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="well">
                <center>
                    <h1 style="color: white;">Social Networking World</h1>
                </center>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="main-content">
                <div class="header">
                    <h3 style="text-align: center;"><strong>Join Our Social Network</strong></h3>
                    <hr>
                </div>
                <div class="1-part">
                    <form action="" method="post">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="u_birthday" class="form-control input-md" placeholder="Email" required="required">
                        </div><br>

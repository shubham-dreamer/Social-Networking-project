            ...
            <div class="col-sm-12">
                ...
                if (isset($_GET['u_id'])) {
                    ...
                    <div class='row'>
                        ...
                        <img class='img-circle' src='users/$image' width='150' height='150px'>
                        <br><br>
                        <ul class='list-group'>
                ...
                ";
                    ...
                    if ($user_id == $userown_id) {
                        echo "<a href ='edit_profile.php?u_id=$userown_id' class='btn btn-success'/>Edit Profile</a>
                    <br><br><br>";
                    }
                    echo "
                    </div>
                ...
                <div id='own_posts'>
                    ...
                    <div class='col-sm-6'>
                    <h3> <a style='text-decoration:none;cursor:pointer;color:#3897f0;' href='
                    user_profile.php?u_id=$user_id'>$user_name</a><h3>
                    ...
                    <div class='row'>
                    <div class='col-sm-12'>
                    <img src='imagepost/$upload_image' style='height:350px'>
                    </div>
                    </div><br>

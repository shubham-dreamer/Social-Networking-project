        ...
        <div class="col-sm-6">
            ...
            if(isset($_GET['u_id'])) {
                ...
                if ($u_id == "new") {
                    echo '
                    <form>
                    <center><h3>Select Someone to start conservation</h3></center>
        ...
        <!-- <div class="col-sm-3">
           ...
           // if (isset($_GET['u_id'])) {
              ...
              //  $user_id = isset($row['user_id']);
               // $user_name = isset($row['user_name']);
                //$f_name = isset($row['f_name']);
               // $l_name = isset($row['l_name']);
               // $describe_user = isset($row['describe_user']);
               // $user_country = isset($row['user_country']);
              //  $user_image = isset($row['user_image']);
               // $register_date = isset($row['user_reg_date']);
               // $gender = isset($row['user_gender']);
           // }
           // if ($get_id == "new") {
           // } else {
           //     echo "

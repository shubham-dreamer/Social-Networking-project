...
function user_posts(){
	...
	while($row_posts=mysqli_fetch_array(($run_posts))){
		...
		$user = "select * from users user_id='$user_id' AND posts='yes'";
		$run_user =mysqli_query($con,$user);
		$row_user=mysqli_fetch_array($run_user);

		$user_name= isset($row_user['user_name']);
		$user_image=isset($row_user['user_image']);
		...
		$user_email =isset($row['user_email']);
...
function results(){
	...
	while($row_posts=mysqli_fetch_array($run_posts)){
		...
		$user_name= isset($row_user['user_name']);
		$first_image=isset($row_user['f_name']);
		$last_name= isset($row_user['l_name']);
		$user_image=isset($row_user['user_image']);
